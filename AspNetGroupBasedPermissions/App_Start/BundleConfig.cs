...
namespace AspNetGroupBasedPermissions
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // custom knockout dataTables
            bundles.Add(new ScriptBundle("~/app/knockoutDatatable").Include(
                      "~/Scripts/app/knockoutDatatable.js"));

            // custom knockout dataTables checkbox
            bundles.Add(new ScriptBundle("~/app/knockoutDatatableCheckbox").Include(
                      "~/Scripts/app/knockoutDatatableCheckbox.js"));
            ...
            // Date datetime picker Styless
            bundles.Add(new ScriptBundle("~/bundles/datetime").Include(
                        "~/Scripts/moment*","~/Scripts/bootstrap-datetimepicker*"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/knockout").Include(
                      "~/Scripts/plugins/knockout/knockout-3.4.0.js"));

            bundles.Add(new ScriptBundle("~/plugins/knockout-sortable").Include(
                      "~/Scripts/plugins/knockout-sortable/knockout-sortable.js"));

            
            // notifyjs plugins
            bundles.Add(new ScriptBundle("~/plugins/notifyjs").Include(
                      "~/Scripts/plugins/notifyjs/notify.min.js"));

            // dom-to-image plugins
            bundles.Add(new ScriptBundle("~/plugins/dom-to-image").Include(
                      "~/Scripts/plugins/dom-to-image/dom-to-image.js"));

            // jqprint plugins
            bundles.Add(new ScriptBundle("~/plugins/jqprint").Include(
                      "~/Scripts/plugins/jqprint/jquery.jqprint-0.3.js"));

            // jspdf plugins
            bundles.Add(new ScriptBundle("~/plugins/jspdf").Include(
                      "~/Scripts/plugins/jspdf/jspdf.debug.js"));

            // js2excel plugins
            bundles.Add(new ScriptBundle("~/plugins/jstoexcel").Include(
                      "~/Scripts/plugins/jstoexcel/jquery.table2excel.min.js"));

            // autonumeric
            bundles.Add(new ScriptBundle("~/plugins/autonumeric").Include(
                      "~/Scripts/plugins/autoNumeric/autoNumeric.min.js"));
        }
    }
}
